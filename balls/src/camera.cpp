...
camera::camera(GLFWwindow* window, glm::vec3 inPos) : pos(inPos), hangle(90.0f), vangle(0.0f), skip(0), prevX(0.0), prevY(0.0) {
	//glfwSetInputMode(window, GLFW_CURSOR, GLFW_CURSOR_DISABLED); // can turn this on for better gaming experience, but makes debugging annoying
}
